...
pub const VECTOR_DIMENSIONS: usize = 512;
...
pub(crate) const INDEX_EVENT_CHANNEL_CAPACITY: usize = 256;
pub(crate) const EMBEDDING_JOB_CHANNEL_CAPACITY: usize = 256;
pub(crate) const EMBEDDING_BATCH_DOC_LIMIT: usize = 64;
pub(crate) const EMBEDDING_MAX_WORKERS: usize = 4;
